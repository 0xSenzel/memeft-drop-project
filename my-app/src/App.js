...
// Constants
const MY_HANDLE = "0xsenzel";
const WEB_LINK = `https://github.com/0xSenzel`;
const OPENSEA_LINK = "";
const TOTAL_MINT_COUNT = 50;
const CONTRACT_ADDRESS = "0x49cA47c095118963126FD9e564419133072b909D";
    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          // If minting is on going, then tell its finished
          /* if(mintButton) {
            setMintButton(false)
          }*/
          console.log(from, tokenId.toNumber());
          alert(
            `Hey there! We've minted your NFT and send it to your wallet. It may be blank right now.It can take a max of 10 min to show up on OpenSea. Here's the link: https://testnets.opensea.io/assets/${CONTRACT_ADDRESS}/${tokenId.toNumber()}`
          );
        });
